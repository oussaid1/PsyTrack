...
final TextStyle subtext=TextStyle(color:(Colors.yellow[100]),fontWeight: FontWeight.w200,fontSize: 18);
final TextStyle maintext=TextStyle(color:(Color(0xFFF2C94C)),fontWeight: FontWeight.w400,fontSize: 24);
