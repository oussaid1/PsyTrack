...
class Day {
 ...
 Day({this.id,this.count59,this.nightMood, this.morningMood, 
 this.afternoonMood, this.eveningMood,
 this.stressLevel, this.anxietyLevel, 
 this.obsessionLevel, this.sleepLevel,this.overAllRate,this.date});
